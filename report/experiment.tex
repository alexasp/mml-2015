...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		Experiment Name   & Peers & Epsilon & Aggregation cost        \\
		\hline
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{fig/adult/eps0.1,bud0.1div1-4,peers10,groups2,reg2e2-pubAll-groupsizetest-withoutlocal-data300-adultmean}
