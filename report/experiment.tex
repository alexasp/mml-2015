...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|l|l|}
		...
		\hline
		Spambase, data availability, disjoint         & 10    & $10-360$  & $2^{-2}$  & $0.1$      & Local      \\
		Spambase, data availability, aggregated    & 10    & $10-360$  & $2^{-2}$  & $0.1$      & Aggregated \\
		Spambase, observing $\lambda$, ensemble & 10    & $10-360$  & $2^{-2}$  & $0.1$  & Ensemble  
	\end{tabular}
...
\todo{add this with both public and party propegation, and mention that we compare these also}
