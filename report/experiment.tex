...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		\textbf{Experiment Name}    & \textbf{Peers} & \textbf{Data} & $\boldsymbol{\lambda}$      \\
		\hline
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|l|}
		\textbf{Experiment Name}            & \textbf{Peers} & \textbf{Data} &
...
\subsection{Effects of Data Availability}

\subsection{Effects of User Base Growth}

\subsection{Minimizing Peer Model Variance}

\subsection{Effects of Model Propegation}

\subsection{Effects of Aggregation Participation}
