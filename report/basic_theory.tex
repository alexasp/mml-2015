...
In the previous example, only a single operation was performed, making the scheme only a partially homomorphic cryptosystem. To be truly considered useful, a scheme needs to be fully homomorphic and support enough operations to  
