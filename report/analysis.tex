...
As mentioned in Section \ref{sec:PropagationPubModel}, \todo[inline]{finish this}
...
\begin{figure}[h!]
	...
	\caption{Spambase. $\epsilon = 1.0, \lambda = [1.0]$, 50 peers, aggregation sizes in range [1, 49]}
