...
\todo[inline]{Compare the figures about data limits, ie data_limit_test_withoutlocalmodel and such. Clearly, with local model is better than without, but it is not clear whether local only or aggregated+local is better.}
