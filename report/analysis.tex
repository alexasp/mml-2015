...
We have restricted our analysis to error rates, though confusion matrices and ROC-curves were produced for all of our experiments. The confusion matrices were used to verify that the classifiers were discriminating between the two classes, and not just making trivial predictions. The remaining confusion matrices are included in the Appendix. \todo[inline]{Include confusion matrices in appendix OR in analysis}
